...
/*
 * Following code will create a new issue row
...
if (isset($_POST['projectName']) && isset($_POST['assignTo']) && isset($_POST['reproducibility'])&&isset($_POST['severity']) && isset($_POST['priority']) && isset($_POST['summary'])&&isset($_POST['description'])) {
...
$reporter_id=intval(mysql_result($result, 0));
    ...
    $result = mysql_query("INSERT INTO mantis_bug_table(project_id, reporter_id, priority, severity, reproducibility,  summary) VALUES('$project_id', '$reporter_id', '$priority','$severity','$reproducibility','$summary')");
